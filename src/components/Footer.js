...
import tw from "../assets/sosmed/twitter.png";
import ig from "../assets/sosmed/instagram.png";
import yt from "../assets/sosmed/youtube.png";
import pt from "../assets/sosmed/path.png";
import lk from "../assets/sosmed/linkedin.png";
          ...
          <div className="row">
            <div className="col-md-3">
              ...
              <p className="mt-2 utama">
                <strong>Charity</strong> merupakan sebuah platform sosial yang
                mempertemukan Masalah Sosial dengan Pemberi Solusi (Penggerak
                Sosial, Sponsor maupun Donatur).
              </p>
            </div>
            <div className="col-md-3">
              <h4>Charity</h4>
