                ...
                <div className="card-columns">
                    {eventState.map((item) => {
                        ...
                        return (
                            <div className="card cardevent">
                                ...
                                <div className="card-body">
                                    <div className="card-title">
                                            ...
                                            <h4 className="text-dark my-0"><a href="#/">
                                                {item.JudulEvent}
                                                </a></h4>
                            ...
                            //     <div className="card  rounded-lg border-0 cardevent">
                            //         <img
                            //             src={item.Img}
                            //             className="card-img-top"
                            //             alt="..."
                            ...
                            //         <div className="card-body">
                            //             <div className="card-title">
                            //                 <a href="#/"><h4 className="text-dark my-0">
                            //                     {item.JudulEvent}
                            //                 </h4></a>
                            //                 <p className="text-muted my-0 date">
                            //                     Berakhir {item.Expire}
                            ...
                            //                     Rp.{item.TotalDonasi}
                            //                 </p>
                            //                 <p className="text-dark">Dari Rp. {item.TargetDonasi}</p>
                            //             </div>
                            //             {id == item.Id_user ? (
                            //             <Button
                            //               onClick={() => {
                            ...
                            //           <p className="judul my-0">{item.JudulEvent}</p>
                            //           <p className="text-muted my-0 date">
                            //             Berakhir : {item.Expire}
                            //           </p>
