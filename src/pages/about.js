                    ...
                    <div className="col-md-6 col-sm-6 col-xs-12 m-b30">
                        <div className="right-content">
                            ...
                            <p className="paragraph-right">
                                Charity adalah situs crowdfunding. kami
                                memberikan bantuan kepada orang yang membutuhkan
                                bantuan dana, baik itu untuk bantuan sosial
                                maupun pinjaman dana untuk perusahaan
                            </p>
                            <h3 className="charity-title">
                                Apa itu crowdfunding?
                            </h3>
                            <p className="paragraph-right">
                                Crowdfunding adalah kegiatan mengumpulkan dana
                                yang melibatkan banyak orang untuk mewujudkan
                                satu tujuan
                            </p>
